...
type ReadOptions struct {
	Opt *C.hyperleveldb_readoptions_t
}
...
func (o *Options) SetCache(cache *Cache) {
	C.hyperleveldb_options_set_cache(o.Opt, cache.Cache)
}

// SetEnv sets the Env object for the new database handle.
func (o *Options) SetEnv(env *Env) {
	C.hyperleveldb_options_set_env(o.Opt, env.Env)
}

// SetInfoLog sets a *C.hyperleveldb_logger_t object as the informational logger
// for the database.
func (o *Options) SetInfoLog(log *C.hyperleveldb_logger_t) {
	C.hyperleveldb_options_set_info_log(o.Opt, log)
}
...
func (o *Options) SetWriteBufferSize(s int) {
	C.hyperleveldb_options_set_write_buffer_size(o.Opt, C.size_t(s))
}
...
func (o *Options) SetParanoidChecks(pc bool) {
	C.hyperleveldb_options_set_paranoid_checks(o.Opt, boolToUchar(pc))
}
...
func (o *Options) SetMaxOpenFiles(n int) {
	C.hyperleveldb_options_set_max_open_files(o.Opt, C.int(n))
}
...
func (o *Options) SetBlockSize(s int) {
	C.hyperleveldb_options_set_block_size(o.Opt, C.size_t(s))
}
...
func (o *Options) SetBlockRestartInterval(n int) {
	C.hyperleveldb_options_set_block_restart_interval(o.Opt, C.int(n))
}
...
func (o *Options) SetCompression(t CompressionOpt) {
	C.hyperleveldb_options_set_compression(o.Opt, C.int(t))
}

// SetCreateIfMissing causes Open to create a new database on disk if it does
// not already exist.
func (o *Options) SetCreateIfMissing(b bool) {
	C.hyperleveldb_options_set_create_if_missing(o.Opt, boolToUchar(b))
}
...
func (o *Options) SetFilterPolicy(fp *FilterPolicy) {
	var policy *C.hyperleveldb_filterpolicy_t
	if fp != nil {
		policy = fp.Policy
	}
	C.hyperleveldb_options_set_filter_policy(o.Opt, policy)
}

// Close deallocates the ReadOptions, freeing its underlying C struct.
func (ro *ReadOptions) Close() {
	C.hyperleveldb_readoptions_destroy(ro.Opt)
}
...
func (ro *ReadOptions) SetVerifyChecksums(b bool) {
	C.hyperleveldb_readoptions_set_verify_checksums(ro.Opt, boolToUchar(b))
}
...
func (ro *ReadOptions) SetFillCache(b bool) {
	C.hyperleveldb_readoptions_set_fill_cache(ro.Opt, boolToUchar(b))
}
...
func (ro *ReadOptions) SetSnapshot(snap *Snapshot) {
	var s *C.hyperleveldb_snapshot_t
	if snap != nil {
		s = snap.snap
	}
	C.hyperleveldb_readoptions_set_snapshot(ro.Opt, s)
}

// Close deallocates the WriteOptions, freeing its underlying C struct.
func (wo *WriteOptions) Close() {
	C.hyperleveldb_writeoptions_destroy(wo.Opt)
}
...
func (wo *WriteOptions) SetSync(b bool) {
	C.hyperleveldb_writeoptions_set_sync(wo.Opt, boolToUchar(b))
}
